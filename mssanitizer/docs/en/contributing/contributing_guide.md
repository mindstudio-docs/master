...
For details about the overall architecture, code framework, and core design ideas of the tool, see [msSanitizer Architecture Design Solution](../development_guide/architecture.md).
