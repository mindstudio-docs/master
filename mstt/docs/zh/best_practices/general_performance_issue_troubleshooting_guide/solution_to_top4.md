...
![img](../../figures/best_practices/general_performance_issue_troubleshooting_guide/zh-cn_image_0000002503927406.png)
...
1. **粗定位**
   ...
   - 配置排查：参考[预检工具指南](https://gitcode.com/Ascend/msit/blob/master/msprechecker/README.md)中典型检查项是否配置正确。
