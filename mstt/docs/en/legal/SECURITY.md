...
For scripting languages such as Python, the source code is released. You are advised to use the public interfaces described in the documentation. Directly calling the source code of interfaces that are not explicitly disclosed is not recommended.
