...
- This tool is intended solely for debugging and development. Users are responsible for any risks and should carefully review the following information::
  - Data processing and deletion: Users are responsible for managing and deleting any data (including but not limited to dumped data) generated while using this tool. Users are advised to delete such data promptly after use to prevent information leakage.
