...
感谢您考虑为 MindStudio Profiler Tools Interface（msPTI）做出贡献！我们欢迎任何形式的贡献，包括错误修复、功能增强、文档改进等，甚至只是反馈。无论您是经验丰富的开发者还是第一次参与开源项目，您的帮助都是非常宝贵的。

您可以通过多种方式支持本项目：

- 通过[Issues](https://gitcode.com/Ascend/mspti/issues)反馈问题。
- 建议或实现新功能。
- 改进或扩展文档。
- 审查Pull Request并协助其他贡献者。
- 传播项目：在博客文章、社交媒体上分享msPTI，或给仓库点个⭐。
...
此外，您可以通过查看[Issues列表](https://gitcode.com/Ascend/mspti/issues)了解项目的发展计划和路线图。
...
4. 编译测试
   ...
   将开发完成的代码编译成whl包进行测试，详细步骤请参见《[msPTI工具安装指南](../install_guide/mspti_install_guide.md)》。
...
- **微信群**：日常交流和快速问答（参见[README](../../../README.md#-建议与交流)）

## 许可证

通过向本项目贡献代码，您同意您的贡献将按照项目的许可证进行授权。详见[LICENSE](../../../LICENSE)文件。

msPTI工具docs目录下的文档适用CC-BY 4.0许可证，详见 [docs/LICENSE](../../LICENSE)。

## 致谢

感谢您为msPTI做出的贡献。您的努力使这个项目变得更加强大和用户友好。期待您的参与！

---

如有任何疑问或需要帮助，请随时在[Issues](https://gitcode.com/Ascend/mspti/issues)中提问，或通过其他社区渠道与我们联系。
