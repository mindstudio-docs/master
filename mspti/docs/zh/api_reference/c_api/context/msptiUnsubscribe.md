...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a>订阅者句柄。</p>
</td>
</tr>
</tbody>
</table>
...
返回MSPTI\_SUCCESS表示成功；订阅者句柄为空或未初始化时返回MSPTI\_ERROR\_INVALID\_PARAMETER，表示失败。
