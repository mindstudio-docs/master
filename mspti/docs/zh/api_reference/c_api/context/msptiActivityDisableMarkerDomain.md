# msptiActivityDisableMarkerDomain<a name="ZH-CN_TOPIC_0000002224330285"></a>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p712111021"><a name="p712111021"></a><a name="p712111021"></a>对应打点域的名称。</p>
</td>
</tr>
</tbody>
</table>
...
返回MSPTI\_SUCCESS表示成功；name为空字符串时返回MSPTI\_ERROR\_INVALID\_PARAMETER，表示失败。
