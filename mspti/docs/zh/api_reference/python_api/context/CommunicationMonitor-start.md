...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p1871112011815"><a name="p1871112011815"></a><a name="p1871112011815"></a>用于传递采集到的通信数据。调用结构体<a href="CommunicationData.md">CommunicationData</a>。</p>
</td>
</tr>
</tbody>
</table>
