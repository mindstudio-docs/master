# CommunicationMonitor.set\_buffer\_size<a name="ZH-CN_TOPIC_0000002267968082"></a>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p1871112011815"><a name="p1871112011815"></a><a name="p1871112011815"></a>Activity Buffer的大小，单位MB，默认8MB。</p>
<p id="p95300307247"><a name="p95300307247"></a><a name="p95300307247"></a>仅支持配置为正整数，配置为其他非法值则返回失败，采集使用默认的Activity Buffer大小。</p>
</td>
</tr>
</tbody>
</table>
...
返回MsptiResult.MSPTI\_SUCCESS则表示成功；返回MsptiResult.MSPTI\_ERROR\_INVALID\_PARAMETER，则参数设置不正确，表示失败。
