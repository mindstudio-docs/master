...
<p id="p10641802345"><a name="p10641802345"></a><a name="p10641802345"></a> can be called for multiple times to disable the collection of multiple fields. By default, the profiling is enabled for all domains.</p>
</td>
</tr>
</tbody>
</table>
...
If the operation is successful, MsptiResult.MSPTI\_SUCCESS is returned. If domain\_name is an empty string, MsptiResult.MSPTI\_ERROR\_INVALID\_PARAMETER is returned, indicating that the operation fails.
