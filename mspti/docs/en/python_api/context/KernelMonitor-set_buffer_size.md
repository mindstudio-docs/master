# KernelMonitor.set\_buffer\_size<a name="ZH-CN_TOPIC_0000002267980704"></a>
...
If MsptiResult.MSPTI\_SUCCESS is returned, the operation is successful. If MsptiResult.MSPTI\_ERROR\_INVALID\_PARAMETER is returned, the parameter setting is incorrect and the operation fails.
