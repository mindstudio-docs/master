# KernelMonitor.start<a name="ZH-CN_TOPIC_0000002143763089"></a>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p1871112011815"><a name="p1871112011815"></a><a name="p1871112011815"></a> is used to transfer the collected kernel data. Call the <a href="KernelData.md">KernelData</a> structure.</p>
</td>
</tr>
</tbody>
</table>
