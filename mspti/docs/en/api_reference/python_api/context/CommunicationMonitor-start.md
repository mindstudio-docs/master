# `CommunicationMonitor.start`<a name="ZH-CN_TOPIC_0000002143882701"></a>
...
```python
def start(self, cb: Callable[[CommunicationData], None]) -> MsptiResult:
```
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p1871112011815"><a name="p1871112011815"></a><a name="p1871112011815"></a>Used to transfer the collected communication data. It invokes the <a href="CommunicationData.md">CommunicationData</a> structure.</p>
</td>
</tr>
</tbody>
</table>
