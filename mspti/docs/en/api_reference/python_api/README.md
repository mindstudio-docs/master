# Python API General Description <a name="ZH-CN_TOPIC_0000002108084148"></a>
...
For details about the functions and usage examples of the msPTI API, see [msPTI Tool](../../user_guide/samples_guide.md).
...
|[MstxMonitor.start](./context/MstxMonitor-start.md)|Marks the start of msTX marker data collection.|
|[MstxMonitor.stop](./context/MstxMonitor-stop.md)|Marks the end of msTX marker data collection.|
...
|**CommunicationMonitor Type**|**CommunicationMonitor Description**|
|[CommunicationMonitor.start](./context/CommunicationMonitor-start.md)|Marks the start of the communication operator profiling.|
|[CommunicationMonitor.stop](./context/CommunicationMonitor-stop.md)|Marks the end of the communication operator profiling.|
|[CommunicationMonitor.flush_all](./context/CommunicationMonitor-flush_all.md)|Calls the callback function to write all activity data in the buffer to the user memory.|
|[CommunicationMonitor.set_buffer_size](./context/CommunicationMonitor-set_buffer_size.md)|Sets the size of the activity buffer before profiling starts.|
...
|[CommunicationData](./context/CommunicationData.md)|Struct corresponding to the activity record type MSPTI_ACTIVITY_KIND_COMMUNICATION.|
...
|[msptiCommunicationDataType](./context/msptiCommunicationDataType.md)|Data type transmitted by the communication operator.|
