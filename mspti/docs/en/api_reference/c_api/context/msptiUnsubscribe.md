# msptiUnsubscribe<a name="ZH-CN_TOPIC_0000001977973404"></a>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a> Subscriber handle.</p>
</td>
</tr>
</tbody>
</table>
...
`MSPTI_SUCCESS` indicates success. If the subscriber handle is null or has not been initialized, `MSPTI_ERROR_INVALID_PARAMETER` is returned, indicating failure.
