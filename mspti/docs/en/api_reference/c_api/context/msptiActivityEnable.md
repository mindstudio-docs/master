...
> [!NOTE]
>
> For details about specific Ascend product models, see [Ascend Product Models](https://www.hiascend.com/document/detail/en/AscendFAQ/ProduTech/productform/hardwaredesc_0001.html).
...
Enables data collection for a specified Activity Kind. This API can be called multiple times, with different `msptiActivityKind` values set for each call. msPTI can collect activity data of different types.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a>The Activity Kind for which data collection is enabled. Set this parameter to the enumerated value of <a href="msptiActivityKind.md">msptiActivityKind</a>.</p>
</td>
</tr>
</tbody>
</table>
