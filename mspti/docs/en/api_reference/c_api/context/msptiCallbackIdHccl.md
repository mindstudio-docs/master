...
```cpp
typedef enum {
    MSPTI_CBID_HCCL_ALLREDUCE = 1,// Indicates that the function to be traced is HcclAllReduce
    MSPTI_CBID_HCCL_BROADCAST = 2,// Indicates that the function to be traced is HcclBroadcast
