...
Stops collecting data for the specified Activity Kind. You can call this API multiple times with `msptiActivityKind` set to different values.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a> The Activity Kind for which data collection is stopped. Set this parameter to the enumerated value of <a href="msptiActivityKind.md">msptiActivityKind</a>.</p>
</td>
</tr>
</tbody>
</table>
