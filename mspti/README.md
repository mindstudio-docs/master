...
| `样例集` | 覆盖 callback、activity、correlation、HCCL、Python monitor 等典型场景，便于快速上手。 | [样例说明](./samples/README.md) / [样例指南](./docs/zh/user_guide/samples_guide.md) |
...
包含 C API 接口和 Python API 接口两种类型，请参见 《[C API 参考](./docs/zh/api_reference/c_api/README.md)》和《[Python API 参考](./docs/zh/api_reference/python_api/README.md)》。
...
🔹 《[版本说明](https://gitcode.com/Ascend/mspti/releases)》 <br>
