...
在NPU业务执行过程中，业务执行时间不及预期，通过采集profiling数据确认，发现有较多处的流同步等等待行为，急需问题定位和性能优化。
...
[ASCEND_LAUNCH_BLOCKING](https://www.hiascend.com/document/detail/zh/Pytorch/2600/comref/Envvariables/docs/zh/environment_variable_reference/ASCEND_LAUNCH_BLOCKING.md)
就会对每个算子进行流同步，用以定位问题。
