...
在[昇腾官网资料](https://www.hiascend.com/document/detail/zh/Pytorch/2600/ptmoddevg/trainingmigrguide/FrameworkPTAdapter/26.0.0/zh/pytorch_model_migration_fine_tuning/overall_optimization_strategy.md)
中，已经列举了较多的优化方法和思路，可以从类似方案中进行学习了解。
