...
>   ```
>
> - The `torch_npu` version must be compatible with the CANN version in the build image. For version compatibility, see [Ascend for PyTorch](https://gitcode.com/Ascend/pytorch).
