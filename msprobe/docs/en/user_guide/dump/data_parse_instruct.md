...
- To convert adump data, ensure that the CANN Toolkit of the matching version has been installed and the CANN environment variables have been configured. For details, see [CANN Software Installation Guide](https://www.hiascend.com/en/cann/download).
