...
* Loss or gnorm may change after msProbe is used. For details, see [Cause Analysis of Model Calculation Result Changes](../../support/faq.md#model-computation-result-change).
...
Stops precision data collection. This API can be added anywhere following **start**. If **stop** is added following the backward propagation code, the forward and backward data between **start** and **stop** is collected.
