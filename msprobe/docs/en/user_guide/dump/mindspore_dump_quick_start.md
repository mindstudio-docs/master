...
5. Analyze the data.
   ...
   The following directory structure is generated in the path specified by `dump_path` (`./output` in this example). You can use the precision pre-check and comparison functions of msProbe to analyze precision.
