...
文档地址：[Data Dump for PyTorch](../user_guide/dump/pytorch_data_dump_instruct.md)
...
以上使能方式只针对fsdp后端，不同配置或使能方式可能会变化。
...
1. 创建config.json文件，用于配置dump参数。
   ...
   config.json配置文件详细介绍请参见[配置文件介绍](../user_guide/dump/config_json_introduct.md)。
