...
- 传播项目：在博客文章、社交媒体上分享msProbe，或给仓库点个⭐。
...
4. 编译测试
   ...
   将开发完成的代码编译成whl包进行测试，详细步骤请参见《[msProbe工具安装指南](../install_guide/msprobe_install_guide.md)》。
...
- **微信群**：日常交流和快速问答（参见[README](../../../README.md)中的建议与交流）

## 许可证

通过向本项目贡献代码，您同意您的贡献将按照项目的许可证进行授权，详见[LICENSE](../legal/LICENSE)文件。

msProbe工具docs目录下的文档适用CC-BY 4.0许可证，详见[docs/LICENSE](../../LICENSE)。

## 致谢

感谢您为msProbe做出的贡献。您的努力使这个项目变得更加强大和用户友好。期待您的参与！

---

如有任何疑问或需要帮助，请随时在[Issues](https://gitcode.com/Ascend/msprobe/issues)中提问，或通过其他社区渠道与我们联系。
