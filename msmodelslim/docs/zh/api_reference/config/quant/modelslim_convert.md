...
<h4 id="2-2-1-preprocessconfig">2.2.1 PreprocessConfig</h4>

**派生类**

| 配置类 | `type` | 说明 | 文档 |
|--------|----------|------|------|
| `RenamePreprocessConfig` | `rename` | `modelslim_convert` 预处理步骤之一：批量重命名权重张量。 | 本页 <a href="#2-2-2-rename">§2.2.2</a> |
| `ConvertPreprocessConfig` | `convert` | `modelslim_convert` 预处理步骤之一：对匹配的线性层做权重变换（拆分/合并等）。 | 本页 <a href="#2-2-4-convert">§2.2.4</a> |

<h4 id="2-2-2-rename">2.2.2 RenamePreprocessConfig</h4>
...
| `patterns` | `list[object]` | 可选 | `[]` | — | 重命名规则列表，逐条应用到匹配的权重名。 | 本页 <a href="#2-2-3-rename-pattern">§2.2.3</a> |

**配置约束**

- 无。

<h4 id="2-2-3-rename-pattern">2.2.3 RenamePattern</h4>
...
<h4 id="2-2-4-convert">2.2.4 ConvertPreprocessConfig</h4>
...
| `ops` | `list[object]` | 可选 | `[]` | — | 权重变换算子列表，如 `chunk`、`merge`。 | 本页 <a href="#2-2-5-convert-op-config">§2.2.5</a> |

**配置约束**

- 无。

<h4 id="2-2-5-convert-op-config">2.2.5 ConvertOpConfig</h4>
...
<h4 id="2-2-6-linear-convert-config">2.2.6 LinearConvertConfig</h4>
...
<h4 id="2-2-7-save-config">2.2.7 SaveConfig</h4>
