...
用户需要自定义调优配置文件，可以参考各策略目录下的 YAML 示例（如 [standing_high.yaml](../../knowledge_base/tuning_strategies/standing_high/standing_high.yaml)）进行自定义。
...
### <span id="21-strategy---调优策略配置">2.1 strategy - 调优策略配置</span>
...
不同调优策略的配置字段差异较大，详细的配置项请参考相应算法文档的「YAML 配置字段详解」章节。策略总览见《[自动调优策略总览](../../knowledge_base/tuning_strategies/README.md)》。目前已支持的算法如下：

- 《[Standing High 调优算法](../../knowledge_base/tuning_strategies/standing_high/standing_high.md)》
- 《[Standing High With Experience 调优算法](../../knowledge_base/tuning_strategies/standing_high_with_experience/standing_high_with_experience.md)》
- 《[Binary Fallback 调优算法](../../knowledge_base/tuning_strategies/binary_fallback/binary_fallback.md)》
...
- standing_high 调优策略配置：[standing_high.yaml](../../knowledge_base/tuning_strategies/standing_high/standing_high.yaml)
- standing_high_with_experience 调优策略配置：[standing_high_with_experience.yaml](../../knowledge_base/tuning_strategies/standing_high_with_experience/standing_high_with_experience.yaml)
- binary_fallback 调优策略配置：[binary_fallback.yaml](../../knowledge_base/tuning_strategies/binary_fallback/binary_fallback.yaml)
