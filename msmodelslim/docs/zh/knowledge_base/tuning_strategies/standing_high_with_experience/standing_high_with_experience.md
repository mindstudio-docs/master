...
- 敏感层分析不会在策略侧预先 `load_model`；详见《[自动调优配置说明导航](../../../api_reference/config/tuning/README.md)》与《[LLM 大模型接入指南](../../ptq/llm/integration_guide_large_language_model_quantization.md)》。
