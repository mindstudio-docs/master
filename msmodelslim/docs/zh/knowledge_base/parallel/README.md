...
本目录收录 msModelSlim **多卡量化**相关的流程指南与术语百科。
...
**说明**：量化路径下会按已适配情况启用 DP、EP、DTS。多卡量化机制不覆盖权重转换（Convert），权重转换走自身方案，具体见《[权重转换使用指南](../ptq/convert/usage_weight_conversion.md)》。
