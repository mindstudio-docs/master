...
**配置协议**: template 字段的配置协议与一键量化配置协议中的 `spec` 字段保持一致，详细配置说明请参考《[一键量化使用说明](../../feature_guide/quick_quantization_v1/usage.md#5-量化配置协议详解)》。
