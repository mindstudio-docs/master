...
建议您首先阅读《[架构说明](../developer_guide/architecture.md)》以了解整体设计逻辑，随后参考以下文档完成模型接入：  

- 《[LLM 大模型接入指南](../developer_guide/integrating_models.md)》  
- 《[多模态理解模型接入指南](../developer_guide/integrating_multimodal_understanding_model.md)》
