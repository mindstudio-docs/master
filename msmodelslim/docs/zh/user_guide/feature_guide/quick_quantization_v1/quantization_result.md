...
## 3. quant_model_description.json 详解
...
#### 4.1.8 WFP8AFP8_DYNAMIC（FP8 动态量化）
...
#### 4.1.11 W4A4_MXFP4（W4A4 MXFP4 量化）
...
#### 4.1.14 FlatQuant_DYNAMIC（FlatQuant 动态量化）
...
#### 4.1.15 NonFusionSmoothQuant（平滑量化）
...
#### 4.1.16 FAQuant（Flash Attention 量化）
...
#### 5.2.1 optional/quarot.safetensors
...
#### 5.2.2 quant_model_description.json 中的描述字段
