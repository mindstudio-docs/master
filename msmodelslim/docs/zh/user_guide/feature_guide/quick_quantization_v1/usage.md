...
|quant_type|与"config_path"不共存| 量化类型。<br>w4a8, w4a8c8, w8a8, w8a8s, w8a8c8, w8a8f8, w8a16, w16a16s，请参考《[大模型支持矩阵](../../model_support/foundation_model_support_matrix.md)》。                                                                                                                                                                |
...
| DualScale | 量化 | [DualScale 配置示例](../../quantization_algorithms/quantization_algorithms/dual_scale.md#yaml配置示例) | [DualScale 配置字段详解](../../quantization_algorithms/quantization_algorithms/dual_scale.md#yaml配置字段详解) |
