...
- `attn --metrics mse` 不在上述范围，需对应 `model_type` 的模型适配器实现 **AttentionMSEAnalysisInterface** 方可使用。该算法的模型支持列表见[Attention MSE 算法适用要求](../knowledge_base/quantization_algorithms/attention_mse/attention_mse.md#适用要求)。
...
- 《[Std：敏感层分析算法说明](../knowledge_base/quantization_algorithms/std/std.md)》
- 《[Quantile：敏感层分析算法说明](../knowledge_base/quantization_algorithms/quantile/quantile.md)》
- 《[Kurtosis：敏感层分析算法说明](../knowledge_base/quantization_algorithms/kurtosis/kurtosis.md)》
...
- 《[Attention MSE（mse）：敏感层分析算法说明](../knowledge_base/quantization_algorithms/attention_mse/attention_mse.md)》
...
- 《[层级 MSE（mse_layer_wise）：敏感层分析算法说明](../knowledge_base/quantization_algorithms/mse_layer_wise/mse_layer_wise.md)》
- 《[模型级 MSE（mse_model_wise）：敏感层分析算法说明](../knowledge_base/quantization_algorithms/mse_model_wise/mse_model_wise.md)》
