...
以及[大模型量化工具依赖安装](../feature_guide/traditional_quantization_v0/foundation_model_compression.md#11-使用前准备) 。
...
[FA量化使用说明](../feature_guide/traditional_quantization_v0/foundation_model_quantization_and_calibration.md#3-fa3量化)  
