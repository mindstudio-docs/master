...
3. 若使用昇腾NPU设备，则需安装TorchNPU及其对应的相关依赖，TorchNPU包的安装请参考《[Ascend for PyTorch 安装](https://gitcode.com/Ascend/pytorch/blob/v2.7.1/docs/zh/installation_guide/quick_install.md)》。
