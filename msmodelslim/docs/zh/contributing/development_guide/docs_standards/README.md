...
| 类型 | 定位 | 模板 | 校验清单 |
| --- | --- | --- | --- |
| 算法词条 | 陈述性知识：是什么 / 原理 / 性质 / 关联 | [01_quantization_glossary_template](./01_quantization_glossary_template.md) | [01_quantization_glossary_checklist](./01_quantization_glossary_checklist.md) |
| 流程指南 | 过程性知识：适用范围 / 输入交付件 / 操作步骤 | [02_process_guide_template](./02_process_guide_template.md) | [02_process_guide_checklist](./02_process_guide_checklist.md) |
| 案例参考 | 实践案例：背景 / 环境 / 步骤 / 结果 / 经验 | [03_general_case_template](./03_general_case_template.md) | [03_general_case_checklist](./03_general_case_checklist.md) |
| 量化配置文档 | 配置接口参考 | [04_quantization_config_document_template](./04_quantization_config_document_template.md) | [04_quantization_config_document_checklist](./04_quantization_config_document_checklist.md) |
| CLI文档 | 命令与接口契约 | [05_cli_api_contract_template](./05_cli_api_contract_template.md) | [05_cli_api_contract_checklist](./05_cli_api_contract_checklist.md) |
