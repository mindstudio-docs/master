...
Constructs a class for outlier suppression, and passes in the model, outlier suppression configuration, calibration data, etc. The input interface is consistent with AntiOutlier of llm_ptq. CPU execution is not supported.
...
Configure all parameters in QuantConfig initialization based on actual requirements.
