...
[W8A16](#2-w8a16-quantization): Linear weight int8 quantization, where activations are not quantized.
[W8A8](#3-w8a8-and-w8a8s-quantization): Linear weight int8 quantization, which applies int8 activation quantization.
[W8A8S](#3-w8a8-and-w8a8s-quantization): Linear weight int8 sparse quantization, which applies int8 activation quantization.
...
## 1. Quantized Weight and Description File Formats

### 1.1 SafeTensors Weight Format
...
### 1.2 JSON Description File Format
...
### 3.2 Quantization and Dequantization Formulas
