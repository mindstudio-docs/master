...
### 11.1 Preparing the Environment and Model

Ensure that the environment configuration and the model download are complete:

- Complete the environment setup and save the model weights to your local directory by referring to [Preparations](#2-preparations).

### 11.2 Defining the Pipeline Execution Function
...
### 11.3 Configuring and Initializing the Cache Adapter
...
### 11.4 Executing the Cache Configuration Search
...
A complete search script example is available in [dit_cache_search_t2v_sp.sh](../../../../../example/osp1_2/dit_cache_search_t2v_sp.sh):
...
### 11.5 Using the Optimized Configuration for Inference
...
#### 11.5.3 Complete Inference Script

A complete inference script example is available in [dit_cache_sample_t2v_sp.sh](../../../../../example/osp1_2/dit_cache_sample_t2v_sp.sh):
...
## 13. Adaptive Sampling Optimization
...
### 15.1 Executing Original Model Inference to Generate Video Search Calibration Baselines
...
### 15.2 Searching for Timesteps

After obtaining the model pipeline object, set the sampling optimization parameters, pass the generated calibration video directory, and call the `ReStepAdaptor` class to execute the `timestep` search. A complete script code sample is available in [search_t2v_sp.sh](../../../../../example/osp1_2/search_t2v_sp.sh):
...
### 15.3 Performing Inference Using the Timesteps Obtained by Search

Inference command example (for a complete script code sample, see [sample_t2v_sp.sh](../../../../../example/osp1_2/sample_t2v_sp.sh)):
...
You can modify the model parameter path and the optimized timestep file path by referring to [search_t2v_sp.sh](../../../../../example/osp1_2/search_t2v_sp.sh), and then execute inference with sampling optimization.
