...
### 1. W8A8 KVCache Quantization Scenario
...
## 2. W8A8 Low-bit Quantization Scenario
...
## 3. W8A8 `per_token` Quantization Scenario
...
## 4. W8A16 `per_channel` MinMax Quantization Scenario
...
## 5. W8A16 `per_channel` HQQ Quantization Scenario
...
## 6. W8A16 `per_channel` GPTQ Quantization Scenario
...
## 7. W8A16 `per_channel` AWQ Quantization Scenario
...
## 8. W8A16 KVCache Quantization Scenario
...
## 9. W8A16 `per_group` Quantization Scenario
...
## 10. Low-bit Sparse Quantization Scenario
...
## 11. W4A8 Dynamic Quantization Scenario
...
## 12. W4A4 Dynamic Quantization Scenario
...
## 14. Simulated Multi-rank Quantization Scenario
