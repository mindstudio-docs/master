...
The algorithm is implemented in [msmodelslim/processor/quarot/offline_quarot/quarot.py](../../../../../msmodelslim/processor/quarot/offline_quarot/quarot.py).
...
- **Procedure**
    1. **(Mandatory) Implement `QuaRotInterface`**
        ...
        - For details, see the implementation of [msmodelslim/model/qwen3/model_adapter.py](../../../../../msmodelslim/model/qwen3/model_adapter.py) or [msmodelslim/model/deepseek_v3/model_adapter.py](../../../../../msmodelslim/model/deepseek_v3/model_adapter.py).
...
**Solution**: Ensure that the Hadamard matrix of the specified dimension exists. Add the matrix of the specified dimension by referring to [msmodelslim/processor/quarot/common/hadamard_txt](../../../../../msmodelslim/processor/quarot/common/hadamard_txt), and supplement it in [msmodelslim/processor/quarot/common/hadamard.py](../../../../../msmodelslim/processor/quarot/common/hadamard.py).
...
- For details, see the implementation examples in [msmodelslim/model/qwen3/model_adapter.py](../../../../../msmodelslim/model/qwen3/model_adapter.py) or [msmodelslim/model/deepseek_v3/model_adapter.py](../../../../../msmodelslim/model/deepseek_v3/model_adapter.py).
