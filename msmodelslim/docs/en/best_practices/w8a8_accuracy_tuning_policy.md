...
Install the msModelSlim tool. For details, see [msModelSlim Installation Guide](../install_guide/install_guide.md).
Install the dependencies for the large-model quantization tool. See [Preparations](../user_guide/feature_guide/traditional_quantization_v0/foundation_model_compression.md#11-preparations).
...
[FA quantization usage](../user_guide/feature_guide/traditional_quantization_v0/foundation_model_quantization_and_calibration.md#3-fa3-quantization)
