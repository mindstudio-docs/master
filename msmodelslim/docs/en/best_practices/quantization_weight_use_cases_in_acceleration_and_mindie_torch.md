...
Install MindIE by following the [MindIE Installation Guide](https://gitcode.com/Ascend/MindIE-LLM/blob/v3.0.0/docs/en/user_guide/install/installation_introduction.md).
