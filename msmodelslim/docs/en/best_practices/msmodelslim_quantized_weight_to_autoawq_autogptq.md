...
For dependency installation, see [Preparations](../user_guide/feature_guide/traditional_quantization_v0/foundation_model_compression.md#11-preparations) in the foundation model quantization guide.
