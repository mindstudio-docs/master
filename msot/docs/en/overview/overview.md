...
Performance Analysis Tool: Supports on-device and simulation data collection, and locates performance bottlenecks through the MindStudio Insight visualization tool. For details, see: [Operator Performance Tuning Tool](https://gitcode.com/Ascend/msopprof).
