...
| 性能 | [**msModeling**](https://gitcode.com/Ascend/msmodeling)                       |  **【建模仿真】** 神经网络推理性能仿真与分析框架，帮助开发者在无物理硬件或部署前期预测模型性能、识别瓶颈并优化配置。|
...
请查阅《[msIT 使用指南](./docs/zh/user_guide/msit_user_guide.md)》，根据具体应用场景选用相应工具，详细使用说明请参见其源码仓库中的 README 文件。    
