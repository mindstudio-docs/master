...
![融合算子查找示例](../figures/best_practices/dsv4-fusion-op-find-process.gif)
...
![融合算子验证示例](../figures/best_practices/dsv4-fusion-op-valid-process.gif)

### 1.3 生成验证结果HTML

![融合算子html示例](../figures/best_practices/dsv4-fusion-op-report-html.gif)
