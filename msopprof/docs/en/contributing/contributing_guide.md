...
For details about the overall architecture, code framework, and core design ideas of the tool, see [msOpProf Architecture Design Solution](../development_guide/architecture.md).
